  ...
  head: () => ({
    meta: [
      ...
      { title: "Saksham Gupta — Interior Design Portfolio" },
      {
        name: "description",
        content:
          "Portfolio of Saksham Gupta, Interior Design professional: residential design, space planning, 2D drafting and visualization.",
      },
      { name: "author", content: "Saksham Gupta" },
